...
export default function LibraryPage() {
  ...
  return (
    <div style={{
      ...
      <FloatingBlob src="/homepage/new-blob-music.png" alt="" size={150} top="13%" right="7%" duration={6.5} delay={0.7} rotate={5} />
      <FloatingBlob src="/homepage/new-blob-drinking.png" alt="" size={160} top="26%" left="6%" duration={8} delay={0.3} rotate={-4} />
      <FloatingBlob src="/homepage/new3-blob-reading.png" alt="" size={180} top="38%" right="1%" duration={7.5} delay={0.9} rotate={6} />
      <FloatingBlob src="/homepage/new2-blob-sandcastle.png" alt="" size={160} top="50%" left="1%" duration={7} delay={0.4} rotate={-6} />
      <FloatingBlob src="/homepage/new3-blob-baking.png" alt="" size={150} bottom="28%" right="6%" duration={6.5} delay={1.1} rotate={4} />
      <FloatingBlob src="/homepage/new3-blob-puzzle.png" alt="" size={170} bottom="14%" left="4%" duration={8} delay={0.5} rotate={-5} />
      <FloatingBlob src="/homepage/new3-blob-spaghetti.png" alt="" size={160} bottom="2%" right="2%" duration={7} delay={0.2} rotate={5} />
