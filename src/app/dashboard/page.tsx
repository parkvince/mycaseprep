...
function SectionLabel({ children }: { children: React.ReactNode }) {
  return (
    <div style={{
      ...
      letterSpacing: "0.08em", color: "var(--hp-soft-foreground)",
      marginBottom: "0.75rem", fontFamily: FONT,
    }}>
      {children}
    </div>
  );
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto", padding: "2.5rem 2rem 5rem" }}>
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} style={{ marginBottom: "2rem" }}>
          <h1 style={{
            ...
            letterSpacing: "-0.02em", color: "var(--hp-foreground)", margin: 0,
          }}>
            Start a case
          </h1>
              ...
              <div style={{ display: "flex", gap: "6px", flexShrink: 0 }}>
                {[0, 1].map(i => (
                  <div key={i} style={{
                    ...
                    background: i < usage.casesUsed ? "var(--hp-border-strong)" : "var(--hp-primary)",
                    border: `1px solid ${i < usage.casesUsed ? "var(--hp-border-strong)" : "var(--hp-primary)"}`,
                  }} />
                ))}
              </div>
            )}
          ...
          {blocked ? (
            <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
              <button disabled style={{
                ...
                border: "none", background: "var(--hp-border)",
                color: "var(--hp-soft-foreground)", fontSize: "1rem",
                fontWeight: 600, fontFamily: FONT, cursor: "not-allowed",
              }}>
              ...
              <button
                ...
                style={{
                  width: "100%", height: "52px", borderRadius: "12px",
                  border: "1px solid var(--hp-border-strong)", background: "white",
                  color: "var(--hp-foreground)", fontSize: "1rem", fontWeight: 600,
            ...
            <button
              ...
              style={{
                width: "100%", height: "52px", borderRadius: "12px",
                border: "none", background: "var(--hp-primary)", color: "white",
