      ...
      >
        ...
        {verificationSent ? (
          <div style={{ padding: "2.5rem 1.75rem", textAlign: "center" }}>
            <div style={{ width: "56px", height: "56px", borderRadius: "9999px", background: "var(--hp-primary-soft)", display: "grid", placeItems: "center", margin: "0 auto 1.25rem" }}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--hp-primary)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/>
                <polyline points="22,6 12,13 2,6"/>
              </svg>
            </div>
            <h2 style={{ fontWeight: 800, fontSize: "1.1rem", color: "var(--hp-foreground)", margin: "0 0 0.5rem", fontFamily: FONT }}>
              Check your email
            </h2>
            <p style={{ fontSize: "0.875rem", color: "var(--hp-soft-foreground)", lineHeight: 1.6, margin: "0 0 1.5rem" }}>
              We sent a verification link to <strong style={{ color: "var(--hp-foreground)" }}>{email}</strong>. Click the link to activate your account.
            </p>
            <button
              onClick={async () => {
                await fetch("/api/auth/send-verification", {
              ...
              style={{ background: "none", border: "none", color: "var(--hp-primary)", fontSize: "0.85rem", fontWeight: 600, cursor: "pointer", fontFamily: FONT }}
            >
              Resend email
            </button>
          </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "1rem", marginBottom: "1.25rem" }}>
                ...
                <div>
                  ...
                  <input
                    ...
                    style={{
                      ...inputStyle,
                      borderColor: emailInvalid ? "#dc2626" : "var(--hp-border)",
                    }}
                    onFocus={e => (e.currentTarget.style.borderColor = "var(--hp-primary)")}
                  />
                  {emailInvalid && (
