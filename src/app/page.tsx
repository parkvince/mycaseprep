...
function TermsModal({ onClose }: { onClose: () => void }) {
  ...
  const cards = [
    ...
    { title: "5. Contact", body: "For questions about these terms, contact the MyCasePrep team at seho.vince@gmail.com." },
  ];
            ...
            <Reveal>
              <div style={{ maxWidth: "860px", margin: "1.5rem auto 0", textAlign: "center" }}>
                <p style={{ fontSize: "0.8rem", color: "var(--hp-soft-foreground)" }}>
                  Questions?{" "}
                  <a href="mailto:seho.vince@gmail.com" style={{ color: "var(--hp-primary)", fontWeight: 600, textDecoration: "none" }}>Contact the MyCasePrep team</a>
