...
export default function LandingPage() {
  ...
  // Logged-out "get started / start a case" CTAs open the Create-account tab, not
  // the bare Sign-in tab, so a brand-new visitor isn't asked to log in to an
  // account they don't have yet.
    ...
    <div style={{
      ...
      <motion.header style={{
        ...
        <div className="hp-nav-links" style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
          ...
          <button
            onClick={() => router.push(user ? "/library" : "/auth?mode=signup")}
            style={textLink}
            onMouseEnter={e => (e.currentTarget.style.color = "var(--hp-foreground)")}
        ...
        {mobileMenuOpen && (
          ...
          >
            {[
              ...
              { label: "Library", action: () => router.push(user ? "/library" : "/auth?mode=signup") },
