      ...
      <div style={wrap}>
        ...
        <div style={{ maxWidth: "760px", margin: "0 auto", padding: "3rem 2rem 5rem" }}>
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
            ...
            {/* Breadcrumb */}
            <div style={{ display: "flex", alignItems: "center", gap: "0.4rem", fontSize: "0.8rem", color: "var(--hp-soft-foreground)", marginBottom: "2rem", fontFamily: FONT }}>
            ...
            <div style={{ marginBottom: "2rem" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "0.6rem", marginBottom: "0.75rem" }}>
                <span style={{ fontSize: "0.72rem", fontWeight: 700, padding: "0.2rem 0.6rem", borderRadius: "9999px", background: "var(--hp-primary-soft)", color: "var(--hp-primary)", textTransform: "uppercase", letterSpacing: "0.06em" }}>
                  Guided
                </span>
            ...
            {/* Meta strip */}
            <div style={{ ...card, display: "flex", gap: 0, padding: 0, marginBottom: "1.25rem", overflow: "hidden" }}>
              {[
                ...
                <div key={item.label} style={{
                  ...
                  borderRight: i < 2 ? "1px solid var(--hp-border)" : "none",
                }}>
                  <div style={sectionLabel}>{item.label}</div>
                  <div style={{ fontSize: "0.9rem", fontWeight: 600, color: "var(--hp-foreground)", textTransform: "capitalize" }}>{item.value}</div>
                </div>
              ))}
            </div>
            ...
            <button
              onClick={handleStart}
              style={{ width: "100%", height: "52px", borderRadius: "12px", border: "none", background: "var(--hp-primary)", color: "white", fontSize: "1rem", fontWeight: 700, fontFamily: FONT, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "0.5rem", boxShadow: "0 3px 0 oklch(0.4 0.16 285)" }}
            >
        ...
        <div style={{ maxWidth: "720px", margin: "0 auto", padding: "3rem 2rem 5rem" }}>
          <motion.div key={currentQuestionId} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
            ...
            {currentQuestion.context && (
              <p style={{ fontSize: "0.875rem", color: "var(--hp-soft-foreground)", lineHeight: 1.7, marginBottom: "1.5rem", padding: "0.875rem 1.1rem", background: "white", borderRadius: "10px", border: "1px solid var(--hp-border)" }}>
                {currentQuestion.context}
              </p>
            )}
              ...
              {currentQuestion.options.map(option => {
                ...
                return (
                  <div
                    ...
                    style={{ padding: "1rem 1.25rem", borderRadius: "12px", border: `1.5px solid ${borderColor}`, background: bg, cursor: showFeedback ? "default" : "pointer", transition: "all 0.15s" }}
                  >
            ...
            {!showFeedback ? (
              ...
              <button
                onClick={handleNext}
                style={{ width: "100%", height: "48px", borderRadius: "12px", border: "none", background: "var(--hp-primary)", color: "white", fontSize: "0.9rem", fontWeight: 700, fontFamily: FONT, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "0.5rem", boxShadow: "0 3px 0 oklch(0.4 0.16 285)" }}
              >
        ...
        <div style={{ maxWidth: "720px", margin: "0 auto", padding: "3rem 2rem 5rem" }}>
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <textarea
              ...
              style={{ width: "100%", minHeight: "200px", background: "white", border: "1px solid var(--hp-border)", borderRadius: "12px", padding: "1.1rem 1.25rem", color: "var(--hp-foreground)", fontSize: "0.9rem", fontFamily: FONT, resize: "vertical", outline: "none", lineHeight: 1.75, marginBottom: "1.25rem", boxSizing: "border-box", transition: "border-color 0.15s" }}
              onFocus={e => (e.currentTarget.style.borderColor = "var(--hp-primary)")}
              onBlur={e => (e.currentTarget.style.borderColor = "var(--hp-border)")}
            />
            <div style={{ fontSize: "0.78rem", color: finalAnswer.trim().length < 40 ? "var(--hp-soft-foreground)" : "#15803d", marginBottom: "1rem", fontWeight: 500 }}>
      ...
      <div style={wrap}>
        ...
        <div style={{ maxWidth: "720px", margin: "0 auto", padding: "3rem 2rem 5rem" }}>
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
            ...
            {/* Your recommendation */}
            <div style={{ ...card, marginBottom: "1rem", borderLeft: "3px solid var(--hp-border-strong)" }}>
