          ...
          <div style={{ marginBottom: "40px" }}>
            ...
            <div style={{
              ...
              {firmEntries.map(([key, config]) => (
                <div
                  key={key}
                  style={optionCard(targetFirm === key)}
          ...
          <div style={{ marginBottom: "40px" }}>
            ...
            <div style={{
              ...
              {timelines.map((t) => (
                <div
                  key={t}
                  style={optionCard(interviewTimeline === t)}
          ...
          <div style={{ marginBottom: "40px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "8px" }}>
              {difficulties.map((d) => (
                <div
                  key={d.value}
                  style={optionCard(defaultDifficulty === d.value)}
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "8px" }}>
              {(["strict", "friendly"] as const).map((p) => (
                ...
                >
                  ...
                  <div style={{ fontSize: "12px", color: "var(--text-secondary)" }}>
                    {p === "strict"
                      ? "Senior partner. High bar, minimal hand-holding."
                      : "Friendly associate. Rigorous but encouraging."}
                  </div>
                </div>
              ))}
            </div>
              ...
              <div style={{
                ...
                <div>
                  ...
                  <p style={{ fontSize: "13px", color: "var(--text-secondary)" }}>
                    Sign out of your MyCasePrep account.
                  </p>
                </div>
                <UserButton />
              </div>
