...
export default function TermsModal({ onClose }: { onClose: () => void }) {
  ...
  const cards = [
    ...
    { title: "4. Privacy & your data", body: "MyCasePrep stores the account and practice data needed to provide the service. Case prompts and responses are processed by third-party AI providers to conduct interviews and generate feedback; MyCasePrep does not train its own models on your transcripts. If you opt in, limited usage events are sent to Amplitude and Google Analytics using an internal account ID, never names, emails, prompts, answers, or transcripts. MyCasePrep does not sell or rent personal data or share it for third-party advertising. Settings lets you change analytics consent, export your account and practice data, or delete your account and saved practice records. Separately submitted feedback may be retained as a support record." },
      ...
      >
        <div style={{ padding: "1.5rem 1.75rem", borderBottom: "1px solid var(--hp-border)", display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          <div>
            ...
            <div style={{ fontSize: "0.75rem", color: "var(--hp-soft-foreground)", marginTop: "2px" }}>Last updated: July 30, 2026</div>
          </div>
